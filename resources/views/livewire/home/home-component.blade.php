...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registerModal">
	...
	<div class="home">
		...
		<div class="hero_slider_container">
				...
				<div class="hero_slide">
					...
					<div class="hero_slide_container d-flex flex-column align-items-center justify-content-center">
						<div class="hero_slide_content text-center">
							<h1 data-animation-in="fadeInUp" data-animation-out="animate-out fadeOut">Obtenha sua <span>Educação</span> hoje!</h1>
						</div>
					</div>
				</div>
			...
			<div class="hero_slider_right hero_slider_nav trans_200"><span class="trans_200">Próximo</span></div>
		</div>
	...
	<div class="popular page_section">
		<div class="container">
			<div class="row">
				<div class="col">
					<div id="curso" class="section_title text-center">
		...
		<div class="container">
			...
			<div class="row services_row">
				...
				<div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
					...
					<h3>Professores Excepcionais</h3>
